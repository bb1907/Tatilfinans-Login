  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <section className="pt-4">
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 font-headline tracking-tight mb-2">En Uygun Tarihi Bul</h1>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <section className="bg-slate-50 rounded-[2rem] p-6 flex items-center justify-between border border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-black text-slate-800 uppercase tracking-widest">Esnek Tarih Aralığı</span>
            </div>
          ...
          <section className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <button className="p-3 bg-slate-50 rounded-2xl text-slate-400 cursor-pointer"><ChevronLeft size={20} /></button>
                <button className="p-3 bg-slate-50 rounded-2xl text-slate-400 cursor-pointer"><ChevronRight size={20} /></button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
              <div className="flex justify-between items-end mb-8">
                <div className="flex flex-col items-center gap-2">
                  <div className="h-24 w-6 bg-slate-100 rounded-full"></div>
                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">TEM</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="h-32 w-6 bg-slate-100 rounded-full"></div>
                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">AĞU</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="h-16 w-6 bg-[#00647c] rounded-full"></div>
                  <span className="text-[8px] font-black text-primary uppercase tracking-widest">EYL</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="h-20 w-6 bg-slate-100 rounded-full"></div>
                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">EKİ</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="h-12 w-6 bg-slate-100 rounded-full"></div>
                  <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">KAS</span>
                </div>
              </div>

              <div className="bg-slate-50 p-6 rounded-3xl flex items-center justify-between border border-slate-100">
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Fark</p>
                  <p className="text-xl font-black text-[#00647c]">-₺12,450</p>
                </div>
      ...
      <div className="flex justify-center pt-4">
        <button className="w-full md:w-fit md:px-12 bg-[#00647c] text-white h-16 rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl shadow-primary/20 active:scale-95 transition-all cursor-pointer">
