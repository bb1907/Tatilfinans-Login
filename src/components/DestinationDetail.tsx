  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <section className="px-6 pt-4">
        ...
        <h1 className="text-4xl font-black text-slate-900 font-headline tracking-tight">Paris'teki Evin</h1>
      </section>

      {/* Filters */}
      <section className="px-6 flex gap-2 overflow-x-auto no-scrollbar">
      ...
      <section className="px-6">
        <motion.div 
          whileHover={{ y: -4 }}
          className="relative rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-200"
        >
          <div className="h-[450px] relative">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              ...
              <div className="flex justify-between items-end">
                <div>
                  <h2 className="text-3xl font-black font-headline leading-tight">Hôtel Plaza<br />Athénée</h2>
                </div>
                <div className="text-right">
                  <p className="text-xs font-bold line-through opacity-50 mb-1">₺14.200</p>
                  <p className="text-3xl font-black">₺11.850</p>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-[10px] font-black text-slate-400 bg-slate-100 px-2 py-1 rounded-lg uppercase tracking-widest">Finansal Özet</span>
              </div>
...
function FilterChip({ label, active = false }: any) {
  return (
    <button className={`whitespace-nowrap px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all ${
...
function HotelItem({ name, rating, price, desc, img, popular = false }: any) {
  return (
    <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-slate-100">
      <div className="h-64 relative">
        <img src={img} alt={name} className="w-full h-full object-cover" />
        <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-slate-400">
          <Heart size={20} />
        </button>
        {popular && (
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="text-primary text-[10px] font-black uppercase tracking-widest border border-primary/20 px-4 py-2 rounded-xl hover:bg-primary/5 transition-all">
            Birikiminle Öde
          </button>
        </div>
      </div>
